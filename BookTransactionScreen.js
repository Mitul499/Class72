...
import { Text, View, TouchableOpacity, TextInput, Image, 
  StyleSheet,KeyboardAvoidingView,ToastAndroid } from 'react-native';
...
export default class TransactionScreen extends React.Component {
    ...
    intiateBookReturn=async()=>{
      db.collection("Transaction").add({
        ...
        'TransactionSite':"return"
      })
      db.collection("Books").doc(this.state.scannedBookId).this.update({
        'BookAvl':true
      })
      db.collection("students").doc(this.state.scannedStudentId).this.update({
